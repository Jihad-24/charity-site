      ...
      <div className="py-[30px] lg:px-[35px] px-5 ">
        <div className="flex justify-between ">
          <div className="text-[#000] flex flex-col gap-5 justify-center w-[700px]">
            <h1 className="lg:text-[56px] text-2xl font-bold w-[500px]">
              Start your charity{" "}
            </h1>
            <p className="lg:text-[56px] text-2xl font-bold w-[500px]">today</p>
            <p className="lg:text-2xl text-[15px] font-bold  text-[#000]">
              Connect with experienced mentors and get guidance on your created
              charities.
            </p>
            <div className="flex gap-[10px] mt-5">
              <Link to="https://experimentlabs.in/login/66091628f26dbb3314a83e32">
                <button
          ...
          <div className="">
            ...
            ></p>
            <img
              className="w-[450px] ms-[95px] mt-[-160px]"
